...
class GMPERunner(Runner):
    ...
    def run(self):
        ...
        self.trainer.policy.actor.under_training = True
        ...
        for episode in range(episodes):
            ...
            # NEW: update magnitude cap schedule each episode
            if hasattr(self.trainer.policy, "update_m_max"):
                self.trainer.policy.update_m_max(episode, episodes)
